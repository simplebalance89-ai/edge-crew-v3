...
AZURE_HOSTS = {
    ...
    # ai-peterwconveyance8025ai117912890367 (Conveyance tenant, East US 2) — model-router, Phi-4-reasoning, gpt-5.2-chat
    "ai_peterwilson": {
    ...
    # peter-mnji0acb-northcentralus — North Central, regional fallback
    "north_central": {
